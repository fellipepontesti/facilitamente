/*
  ...
  - The `psicologo_id` column on the `users` table would be dropped and recreated. This will lead to data loss if there is data in the column.
...
*/
-- DropForeignKey
ALTER TABLE "users" DROP CONSTRAINT "users_psicologo_id_fkey";
